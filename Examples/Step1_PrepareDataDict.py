...
source_dir_path = r'E:\Raman data\WDF data\12_21_20_ColonExosome'
export_dir_path = r'E:\Raman data\TXT data\12_21_20_ColonExosome'
...
## Do comment the following line when idle
# pd.ranking_selection(source_path, export_path, n_each_map=5, thr=22, copy=True)
