...
X_training, label_training, group_training, sample_name_training, raman_shift, map_index_training = uti.input(training_data_dict_path)
...
X_test, label_test, _, sample_name_test, raman_shift, map_index_test = uti.input(test_data_dict_path)
...
clf_svc.fit(X_train, group_training)
