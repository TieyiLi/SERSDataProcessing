#########################################################
# This file contains the function which is designed for #
# exporting original .wdf spectral files generated by   #
# ReniShaw Raman spectroscopy to .txt files.           #
#########################################################
    ...
    for sample_folder_name in os.listdir(source_folder_path):
        ...
        for map_name in os.listdir(sample_folder_path):
            ...
            if '@' in map_name:
                ...
                # Print the (.wdf) file path which is not square fine mapping
                else:
                    print(wdf_path)
